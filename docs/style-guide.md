...
Tailwind v4 implementation reference. All tokens are defined in
...
| Axis | Values                                        |
| ---- | --------------------------------------------- |
| Mode | `Light` (default), `Dark` (system preference) |

Theme follows the user's OS/browser color preference automatically via the
native `light-dark()` CSS function. No JavaScript needed. Dark palette is from
Hangul Learning Dashboard in `docs/ui.pen`.

---

## Colours

Use CSS variables via Tailwind arbitrary values: `bg-[var(--primary)]`,
`text-[var(--foreground)]`, etc.

### Core palette

| Token                      | Light     | Dark      | Usage                    |
| -------------------------- | --------- | --------- | ------------------------ |
| `--background`             | `#FFFFFF` | `#1A1918` | Page background          |
| `--foreground`             | `#2A2933` | `#F5F4F1` | Default text             |
| `--card`                   | `#FFFFFF` | `#2A2826` | Card surfaces            |
| `--card-foreground`        | `#2A2933` | `#F5F4F1` | Card text                |
| `--primary`                | `#5749F4` | `#4D9B6A` | Primary actions, buttons |
| `--primary-foreground`     | `#FFFFFF` | `#FFFFFF` | Text on primary          |
| `--secondary`              | `#D9D9DB` | `#3A3836` | Secondary buttons, tabs  |
| `--secondary-foreground`   | `#2A2933` | `#F5F4F1` | Text on secondary        |
| `--destructive`            | `#CC3314` | `#CC3314` | Destructive actions      |
| `--destructive-foreground` | `#FFFFFF` | `#FFFFFF` | Text on destructive      |
| `--muted`                  | `#F5F5F5` | `#2A2826` | Muted backgrounds        |
| `--muted-foreground`       | `#616167` | `#9C9B99` | Secondary/caption text   |
| `--accent`                 | `#F5F5F5` | `#2A2826` | Subtle highlights        |
| `--accent-foreground`      | `#2A2933` | `#F5F4F1` | Text on accent           |
| `--tile`                   | `#F5F5F5` | `#2A2826` | Tile/card alt surface    |
| `--input`                  | `#C5C5CB` | `#3A3836` | Input borders            |
| `--border`                 | `#C5C5CB` | `#3A3836` | General borders          |
| `--ring`                   | `#E1E2E5` | `#666666` | Focus rings              |
| `--popover`                | `#FFFFFF` | `#2A2826` | Dropdowns, tooltips      |
| `--popover-foreground`     | `#2A2933` | `#F5F4F1` | Text in popovers         |
...
| Token                  | Light     | Dark      | Usage                         |
| ---------------------- | --------- | --------- | ----------------------------- |
| `--accent-green`       | `#3D8A5A` | `#4D9B6A` | Green accent, primary in dark |
| `--accent-light-green` | `#C8F0D8` | `#C8F0D8` | Decorative green accent       |
| `--accent-warm`        | `#D89575` | `#D89575` | Warm decorative accent        |
...
Cards use **large** (`--radius-l`). Tooltips, dropdowns & checkboxes use
**medium** (`--radius-m`).
...
All components below are defined in the halo design system. Refer to these
patterns when building w/ Tailwind.
...
- Variants: Info / Success / Warning / Error (each w/ matching `--color-*` bg &
  fg)
...
- Container: `--card` bg, `1px solid var(--input)`, `rounded-full`,
  `padding: 8px`
...
- Active item: `--sidebar-accent` bg, `rounded-[24px]`,
